...
namespace Microsoft.Dash.Server.Handlers
{
    public class ControllerOperations
    {
        ...
        public static CloudStorageAccount GetMasterAccount()
        {
        ...
        public static void ReadMetaData(CloudStorageAccount masterAccount, string origContainerName, string origBlobName, out string accountName, out string accountKey, out string containerName, out string blobName)
        {
        ...
        public static Uri GetForwardingUri(HttpRequestBase request, string accountName, string accountKey, string containerName)
        {
        ...
        public static Uri GetRedirectUri(HttpRequestBase request, string accountName, string accountKey, string containerName, string blobName)
        {
            CloudStorageAccount account = GetAccount(accountName, accountKey);
            CloudBlobContainer container = GetContainerByName(account, containerName);
        ...
        public static SharedAccessBlobPolicy GetSasPolicy(HttpRequestBase request)
        {
        ...
        public static async void CreateNamespaceBlob(HttpRequestBase request, CloudStorageAccount masterAccount, string container, string blob)
        {
            string accountName = "";
            string accountKey = "";
        ...
        //getting storage account name and account key from file account, by using simple hashing algorithm to choose account storage
        public static void getStorageAccount(CloudStorageAccount masterAccount, string masterBlobString, out string accountName, out string accountKey)
        {
        ...
        /// <returns></returns>
        public static Int64 GetInt64HashCode(string strText, int numAcc)
        {
            long hashCode = 0;
        ...
        private static void getStorageAccountRoundRobin(CloudStorageAccount masterAccount, out string accountName, out string accountKey)
        {
        ...
        public static void readAccountData(CloudStorageAccount masterAccount, int currAccount, out string accountName, out string accountKey)
        {
        ...
        public static Int32 NumOfAccounts()
        {
        ...
        public static HttpRequestBase RequestFromContext(HttpContext context)
        {
